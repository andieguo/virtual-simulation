                    ...
                    '<div class="panel-sensor" id="cam_video">'+
                                ...
                                '<div class="body">'+
                                    '<div class="row">'+
                                        '<div class="col-md-12">'+
                                            '<div class="camera">'+
                                                '<img id = "img_cam_video" class="camera-img" src="images/camera-bg.jpg" alt="" width="100%" />'+
                                                '<div class="camera-bg">'+
                                                '</div>'+
                                            '</div>'+
                                        '</div>'+
    ...
    var  html = '<h3 class="title">'+prop.title+'</h3>'+
                '<div class="body">'+
                    '<div class="row">'+
                        '<div class="col-md-12">'+
                            '<div class="camera">'+
                                '<img id = "img_'+prop.tid+'" class="camera-img" src="images/camera-bg.jpg" alt="" width="100%" />'+
                                '<div class="camera-bg">'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
